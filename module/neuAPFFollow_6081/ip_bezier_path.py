...
def calc_4points_bezier_path(sx, sy, syaw, gx, gy, gyaw, offset):  # offset:控制曲线平滑程度的参数,值越大，与起点和终点的距离就越大，曲线也就越平滑
    """
    ...
    control_points = np.array(
        [[sx, sy],
         ...
         [gx, gy]])
    # control_points = np.array([[sx, sy], [280, 222], [550, 22], [gx, gy]])
...
def main():
    ...
    sx = 10.0  # [m]
    sy = 1.0  # [m]
    s_yaw = np.radians(89.0)  # [rad]

    gx = 100.0  # [m]
    gy = 30.0  # [m]
    g_yaw = np.radians(314.0)  # [rad]
    offset = 3.0
